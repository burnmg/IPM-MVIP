...
def run():
    ...
    work_sheet = wb.get_sheet_by_name('SUMMARY')
    ...
    target_variables = ['x2', 'x4']
    eq1 = UnknownEquation('x2')
    eq2 = UnknownEquation('x4')

    correct_equation1 = UnknownEquation('x2', 'x2')
    ...
    correct_equation2 = UnknownEquation('x4', 'x4')
    ...
    return main.run(100, variables, target_variables, known_rates, work_sheet, data_locations, correct_equation_pair, test_mode=True)
